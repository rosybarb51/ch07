...
//	자동으로 추가된 기본 생성자의 첫 줄에 super() 를 자동으로 입력하여 부모 객체의 생성자를 호출함.
	
//	자손 객체의 생성자를 명시하였을 경우, 컴파일러가 super()를 사용하여 부모 객체의 생성자를 자동으로 호출(조건 : 부모 객체의 생성자가 기본 생성자였을 경우)
...
//	@어노테이션~! 오버라이드
	...
	@Override
	void bell() {
		System.out.println("DMB 폰의 벨소리가 울립니다.");
